...
however, it is the data.php file which contains the php code which allows for uploading and updatating the 
csv files. I have interpreted that this is a correct method for this.

When uploading new input for the database, the user write the date of birth in the format yyyy-mm-dd, 
which will be converted and saved as unix timestamp when uploaded to the database. This date will 
again be converted back to the original format when displayed on the website.